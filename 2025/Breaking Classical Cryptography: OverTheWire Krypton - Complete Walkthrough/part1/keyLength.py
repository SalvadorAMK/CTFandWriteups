...
# PURPOSE: Implements the Kasiski Examination to estimate the Vigenere key length.
#          Searches for repeated sequences of 3-5 characters in the ciphertext,
#          then calculates the GCD of the distances between repetitions.
#          The most probable key length is the one whose multiples divide
#          the most inter-sequence distances.
#
# Usage:
#   python3 keyLength.py <filename>
#   Example: python3 keyLength.py found1
# ==============================================================================
